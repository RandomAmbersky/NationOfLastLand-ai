...
pub fn create_base(world: &mut World, position: (f32, f32)) -> hecs::Entity {
    ...
    let fraction = crate::game::components::FractionComponent::new(crate::game::components::Fraction::Player);
    world.spawn((base, Position { x: position.0, y: position.1 }, selection, fraction))
}
