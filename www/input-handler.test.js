...
describe('InputHandler', () => {
  ...
  describe('setupEventListeners', () => {
    it('should add event listeners to canvas', () => {
      ...
      expect(gameDemo.app.view.addEventListener).toHaveBeenCalledWith('mousedown', expect.any(Function))
      expect(gameDemo.app.view.addEventListener).toHaveBeenCalledWith('mousemove', expect.any(Function))
      expect(gameDemo.app.view.addEventListener).toHaveBeenCalledWith('mouseup', expect.any(Function))
      expect(gameDemo.app.view.addEventListener).toHaveBeenCalledWith('mouseleave', expect.any(Function))
      expect(gameDemo.app.view.addEventListener).toHaveBeenCalledWith('click', expect.any(Function))
      expect(gameDemo.app.view.addEventListener).toHaveBeenCalledWith('dblclick', expect.any(Function))
    })
  })
  ...
  describe('_toGameCoords', () => {
    it('should convert screen coordinates to game coordinates', () => {
      gameDemo.app.screen = { width: 800, height: 600 }
